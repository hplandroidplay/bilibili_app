...
class ExpandableContent extends StatefulWidget {
  ...
  const ExpandableContent({Key key, @required this.model}) : super(key: key);
...
class _ExpandableContentState extends State<ExpandableContent>
  ...
  _buildInfo() {
    ...
    return Row(
      children: [
        ...smallIconText(Icons.ondemand_video,
            widget.model.view), // 插入 smallIconText方法，注意 smallIconText 没有返回值
