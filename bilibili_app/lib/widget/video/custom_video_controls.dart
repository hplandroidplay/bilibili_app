...
///自定义播放器UI
class CostomMaterialControls extends StatefulWidget {
  //初始化时是否展示loading
  ...
  State<StatefulWidget> createState() {
    return _CostomMaterialControlsState();
  }
}

class _CostomMaterialControlsState extends State<CostomMaterialControls>
